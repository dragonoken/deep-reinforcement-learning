...
T_UPDATE = int(32e2)    # how often to update the target network
...
A = 0.8            # randomness vs priority parameter
INIT_BETA = 0.0         # initial importance-sampling weight
P_EPS = 1e-3            # priority epsilon
N_STEPS = 3             # multi-step number of steps
V_MIN = -300            # distributional learning maximum support bound
V_MAX = 300             # distributional learning minimum support bound
CLIP = 10               # gradient clipping (`None` to disable)

# Model Hyperparameters
N_ATOMS = 51            # number of atoms used in distributional network
INIT_SIGMA = 0.1        # initial noise parameter values
